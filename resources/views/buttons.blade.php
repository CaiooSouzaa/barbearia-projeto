      ...
      <main class="page-content" id="perspective">
        <div class="content-wrapper">
          <div class="page-header page-header-perspective">
            <div class="page-header-left"><a class="brand" href="index;"><img src="img/logo-default-dark-200x36.png" alt="" width="200" height="36"/></a></div>
          ...
          <div id="wrapper">
            <div class="page-title">
              <div class="page-title-content">
                <div class="shell">
                  <p class="page-title-header">Buttons</p>
                </div>
              </div>
            </div>
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                <h3>Button Sizes</h3>
                <p>4 different sizes: large, default, small and very small.</p>
                <div class="group-xl group-middle">
                  <div class="btn btn-lg btn-primary">Large size</div>
                  <div class="btn btn-primary">Default size</div>
                  <div class="btn btn-sm btn-primary">Small size</div>
                  <div class="btn btn-xs btn-primary">VERY Small size</div>
                </div>
              </div>
            </section>
            ...
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                <h3>Button Shapes</h3>
                <p>4 different shapes: default, round, square, and circle.</p>
                <div class="group-xl group-middle">
                  <div class="btn btn-default-size btn-primary">default</div>
                  <div class="btn btn-default-size btn-primary btn-round">Round</div>
                  <div class="btn btn-default-size btn-primary btn-rect">square</div>
                  <div class="btn btn-default-size btn-primary btn-circle">Circle</div>
                </div>
              </div>
            </section>
            ...
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                ...
                <div class="group-xl group-middle">
                  <div class="btn btn-default-size btn-icon btn-icon-right btn-primary"><span class="icon material-icons-person_outline"></span>Icon right</div>
                  <div class="btn btn-default-size btn-icon btn-icon-left btn-primary"><span class="icon material-icons-info_outline"></span>Icon left</div>
                  <div class="btn btn-default-size btn-icon btn-icon-right btn-kangaroo-outline"><span class="icon material-icons-favorite_border"></span>Icon right</div>
                  <div class="btn btn-default-size btn-icon btn-icon-left btn-kangaroo-outline"><span class="icon material-icons-info_outline"></span>Icon left</div>
                </div>
              </div>
            </section>
            ...
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                ...
                <div class="group-xl group-middle">
                  <div class="btn btn-default-size btn-primary btn-circle btn-shadow">Shadow</div>
                  <div class="btn btn-default-size btn-white-pickled-bluewood btn-circle btn-shadow">Shadow</div>
                </div>
              </div>
            </section>
