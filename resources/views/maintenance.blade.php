    ...
    <div class="page">
      <main class="page-content" id="perspective">
        <div class="content-wrapper">
          ...
          <div id="wrapper">
            <section class="section-sm bg-periglacial-blue one-screen-page-content text-center">
              <div class="shell">
                <h2>Maintenance</h2>
                <div class="p text-width-smaller">
                  <p class="big">Our website is currently under maintenance. We are preparing our website to give you the best user experience you can have on our website.</p>
                </div><a class="btn btn-sm btn-style-1 btn-primary" href="index.php">Back to homepage</a>
              </div>
            </section>
