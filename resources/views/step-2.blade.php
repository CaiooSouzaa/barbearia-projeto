        ...
        <div class="content-wrapper">
          ...
          <div id="wrapper">
            <section class="section-xs bg-periglacial-blue one-screen-page-content text-center">
              <div class="shell"><a class="link link-primary link-return" href="step-1.php">Back</a></div>
              <div class="shell">
                    ...
                    <div class="range range-sm-center range-md-left range-30">
                      <div class="cell-sm-8 cell-md-6">
                        <div class="thumbnail-option">
                          <div class="thumbnail-option-left"><img src="img/team-1-170x180.jpg" alt="" width="170" height="180"/>
                          </div>
                          <div class="thumbnail-option-body">
                            <div class="thumbnail-option-title">Simon wilson</div>
                            ...
                            <div class="thumbnail-option-panel"><a class="btn btn-xs btn-primary btn-circle" href="step-3.php">Choose</a></div>
                          </div>
                        </div>
                      </div>
                      <div class="cell-sm-8 cell-md-6">
                        <div class="thumbnail-option">
                          <div class="thumbnail-option-left"><img src="img/team-2-170x180.jpg" alt="" width="170" height="180"/>
                          </div>
                          <div class="thumbnail-option-body">
                            <div class="thumbnail-option-title">Matthew Phillips</div>
                            <ul class="thumbnail-option-list">
                              <li>mo</li>
                              <li class="active">tu</li>
                              <li class="active">we</li>
                      ...
                      <div class="cell-sm-8 cell-md-6">
                        <div class="thumbnail-option">
                          <div class="thumbnail-option-left"><img src="img/team-3-170x180.jpg" alt="" width="170" height="180"/>
                          </div>
                          <div class="thumbnail-option-body">
                            <div class="thumbnail-option-title">harry anderson</div>
                            <ul class="thumbnail-option-list">
                              <li>mo</li>
                              <li class="active">tu</li>
                              <li class="active">we</li>
                      ...
                      <div class="cell-sm-8 cell-md-6">
                        <div class="thumbnail-option">
                          ...
                          <div class="thumbnail-option-body">
                            <div class="thumbnail-option-title">James Young</div>
                            <ul class="thumbnail-option-list">
                              <li>mo</li>
                              <li class="active">tu</li>
                              <li class="active">we</li>
                      ...
                      <div class="cell-sm-8 cell-md-6">
                        <div class="thumbnail-option">
                          ...
                          <div class="thumbnail-option-body">
                            <div class="thumbnail-option-title">Scott Russell</div>
                            <ul class="thumbnail-option-list">
                              <li>mo</li>
                              <li class="active">tu</li>
                              <li class="active">we</li>
