      ...
      <main class="page-content" id="perspective">
        <div class="content-wrapper">
          <div class="page-header page-header-perspective">
            <div class="page-header-left"><a class="brand" href="index.html"><img src="img/logo-default-dark-200x36.png" alt="" width="200" height="36"/></a></div>
          ...
          <div id="wrapper">
            <div class="page-title">
              <div class="page-title-content">
                <div class="shell">
                  <p class="page-title-header">Our Barbers</p>
                </div>
              </div>
            </div>
                  ...
                  <div class="cell-sm-6 cell-md-4 height-fill">
                    <div class="thumbnail-card"><img class="thumbnail-card-image" src="img/barbers-4-370x310.jpg" alt="" width="370" height="310"/>
                      <div class="thumbnail-card-body">
                        ...
                        <div class="thumbnail-card-text">
                          <p>Edward is a trained barber with more than 10 years of experience</p>
                        </div>
                        <ul class="inline-list inline-list-md">
                          <li><a class="icon icon-xs link-gray-base fa-facebook" href="#"></a></li>
                          <li><a class="icon icon-xs link-gray-base fa-twitter" href="#"></a></li>
                  ...
                  <div class="cell-sm-6 cell-md-4 height-fill">
                    <div class="thumbnail-card"><img class="thumbnail-card-image" src="img/barbers-5-370x310.jpg" alt="" width="370" height="310"/>
                      <div class="thumbnail-card-body">
                        ...
                        <div class="thumbnail-card-text">
                          <p>Scott is an internationally acknowledged barber.</p>
                        </div>
                        <ul class="inline-list inline-list-md">
                          <li><a class="icon icon-xs link-gray-base fa-facebook" href="#"></a></li>
                          <li><a class="icon icon-xs link-gray-base fa-twitter" href="#"></a></li>
                  ...
                  <div class="cell-sm-6 cell-md-4 height-fill">
                    <div class="thumbnail-card"><img class="thumbnail-card-image" src="img/barbers-6-370x310.jpg" alt="" width="370" height="310"/>
                      <div class="thumbnail-card-body">
                        ...
                        <div class="thumbnail-card-text">
                          <p>James is one of our barbers who takes walk-ins every day.</p>
                        </div>
                        <ul class="inline-list inline-list-md">
                          <li><a class="icon icon-xs link-gray-base fa-facebook" href="#"></a></li>
                          <li><a class="icon icon-xs link-gray-base fa-twitter" href="#"></a></li>
            ...
            <footer class="page-footer page-footer-default">
              <div class="shell">
                <div class="range range-xs-center">
                  <div class="cell-lg-10"><a class="brand" href="index.html"><img src="img/logo-default-dark-200x36.png" alt="" width="200" height="36"/></a>
          ...
          <nav class="rd-navbar rd-navbar-default" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-sm-device-layout="rd-navbar-fixed" data-md-layout="rd-navbar-sidebar" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-sidebar" data-stick-up-clone="false">
            <div class="rd-navbar-inner">
              <div class="rd-navbar-panel">
                ...
                <div class="rd-navbar-brand"><a class="brand-name" href="index.html"><img src="img/logo-default-dark-200x36.png" alt="" width="200" height="36"/></a></div>
              </div>
