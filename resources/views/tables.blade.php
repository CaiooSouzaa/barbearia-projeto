          ...
          <div id="wrapper">
            <div class="page-title">
              <div class="page-title-content">
                <div class="shell">
                  <p class="page-title-header">Tables</p>
                </div>
              </div>
            </div>
            <section class="section-xl bg-periglacial-blue">
              <div class="shell">
                <div class="table-custom-responsive table-round">
            ...
            <section class="section-xl bg-periglacial-blue">
              <div class="shell">
                <div class="table-custom-responsive table-round">
                  <table class="table-custom table-custom-light table-custom-bordered">
                    <thead>
                      <tr>
                        <th>Column 1</th>
                        <th>Column 2</th>
            ...
            <section class="section-xl bg-periglacial-blue">
              <div class="shell">
                <div class="table-custom-responsive table-round">
                  <table class="table-custom table-custom-primary table-custom-striped">
                    <thead>
                      <tr>
                        <th>Column 1</th>
                        <th>Column 2</th>
