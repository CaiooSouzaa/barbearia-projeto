              ...
              <div class="shell"><a class="link link-primary link-return" href="shop.php">Back</a>
                <div class="table-custom-responsive table-cart-wrap">
                  <table class="table-cart">
                    ...
                    <tbody>
                      <tr>
                        <td><img class="cart-image" src="img/cart-1-80x82.png" alt="" width="80" height="82"/>
                        </td>
                        <td>
                          <p class="cart-title"><a href="single-product.php">Uppercut Deluxe Pomade</a></p>
                        </td>
                        <td>
                          <p class="cart-price">$34.99</p>
                        </td>
                        <td>
                          <input type="number" data-zeros="false" value="2" min="1" max="40">
                        </td>
                        <td>
                          <p class="cart-price">$69.98</p>
                        </td>
                        <td><a class="cart-control" href="#"></a></td>
                      </tr>
                      <tr>
                        <td><img class="cart-image" src="img/cart-1-80x82.png" alt="" width="80" height="82"/>
                        </td>
                        <td>
                          <p class="cart-title"><a href="single-product.php">Uppercut Deluxe Extra</a></p>
                        </td>
                        <td>
                          <p class="cart-price">$44.99</p>
                        </td>
                        <td>
                ...
                <div class="table-cart-footer">
                  <div class="table-cart-footer-left">
                    <label class="checkbox-inline checkbox-modern">
                      <input class="checkbox-custom" type="checkbox">I have a coupon
                    </label>
                  </div>
                ...
                <div class="table-cart-action-panel"><a class="btn btn-circle btn-primary" href="checkout.php">PROCEED TO CHECKOUT</a></div>
              </div>
            </section>
