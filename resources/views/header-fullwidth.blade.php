      ...
      <main class="page-content" id="perspective">
        <div class="content-wrapper">
          <div id="wrapper">
            ...
            <section class="jumbotron-custom jumbotron-custom-3 bg-white bg-image bg-image-custom bg-image-center" style="background-image: url(img/home-three-1-1920x800.jpg);">
