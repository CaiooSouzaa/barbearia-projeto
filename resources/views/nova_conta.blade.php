                  ...
                  <div class="cell-sm-10 cell-md-8 cell-lg-6">
                    <div class="inset-sm-25">
                      ...
                      <form class="rd-mailform">
                        ...
                        <div class="form-group">
                          <label class="form-label-outside" for="login-email">TELEFONE</label>
                          <input class="form-control" id="login-password" type="text" name="pass" data-constraints="@@Required">
                        </div>
                        <button class="btn btn-sm btn-primary btn-block btn-circle" type="submit">criar</button>
                      </form>
                    </div>
                  </div>
                </div>
