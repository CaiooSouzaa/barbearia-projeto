      ...
      <main class="page-content" id="perspective">
        <div class="content-wrapper">
          <div class="page-header page-header-perspective page-header-perspective-transparent">
            <div class="page-header-left"><a class="brand" href="index.php">
                <div class="brand-logo-default"><img src="img/logo-default-dark-200x36.png" alt="" width="200" height="36"/>
                </div>
                <div class="brand-logo-white"><img src="img/logo-default-light-200x36.png" alt="" width="200" height="36"/>
                </div></a></div>
          ...
          <div id="wrapper">
            <section class="jumbotron-custom jumbotron-custom-1 bg-gray-base bg-image text-center" style="background-image: url(img/bg-image-2.jpg);">
              <div class="jumbotron-custom-content">
                <div class="shell">
                  <div class="range range-sm-center">
                    <div class="cell-sm-10 cell-lg-9"><a class="brand-big" href="index.php"><img src="img/logo-big-light-160x160.png" alt="" width="160" height="160"/></a>
            ...
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                <article class="box-promo">
                  <div class="box-promo-left"><img class="box-promo-image" src="img/home-1-585x580.jpg" alt="" width="585" height="580"/>
                  </div>
                  <div class="box-promo-body">
                    ...
                    <div class="box-promo-control"><a class="btn btn-sm btn-circle btn-primary" href="about.php">learn more</a></div>
                  </div>
                </article>
              </div>
            </section>
            ...
            <section class="section-xxl bg-gray-dark bg-gray-dark-overlay bg-image" style="background-image: url(img/bg-image-3.jpg);">
              <div class="shell">
                <div class="range">
            ...
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                ...
                <article class="box-post box-post-dark box-post-reverse box-post-image-right-bottom">
                  <div class="box-post-left"><img class="box-post-image" src="img/box-post-1-530x490.png" alt="" width="530" height="490"/>
                  </div>
                  <div class="box-post-body">
                    <p class="box-post-title"><a href="single-post.php">Visiting a Barber</a></p>
                    ...
                    </div><a class="btn btn-sm box-post-control" href="single-post.php">READ MORE</a>
                  </div>
                </article>
                <article class="box-post">
                  <div class="box-post-left"><img class="box-post-image" src="img/box-post-2-530x490.png" alt="" width="530" height="490"/>
                  </div>
                  <div class="box-post-body">
                    <p class="box-post-title"><a href="single-post.php">What Haircut Suits You</a></p>
                    <div class="box-post-text">
                ...
                <article class="box-post box-post-dark box-post-reverse">
                  <div class="box-post-left"><img class="box-post-image" src="img/box-post-3-530x490.png" alt="" width="530" height="490"/>
                  </div>
                  <div class="box-post-body">
                    <p class="box-post-title"><a href="single-post.php">Top 7 Shaving products</a></p>
                    <div class="box-post-text">
