          ...
          <div class="page-header page-header-perspective">
            ...
            <div class="page-header-center">
              <div class="step-progress">
                <div class="step-progress-caption"><span>done</span><img src="img/icon-done-15x14.png" alt="" width="15" height="14"/>
                </div>
              </div>
            </div>
            ...
            <section class="section-xl bg-periglacial-blue one-screen-page-content text-center">
              <div class="shell">
                ...
                <div class="p text-width-small">
                  <p class="big">Thanks for submitting your appointment! Our administrators will contact you shortly to confirm your booking and to answer questions you may have.</p>
