          ...
          <div id="wrapper">
            <div class="page-title">
              <div class="page-title-content">
                <div class="shell">
                  <p class="page-title-header">Progress Bars</p>
                </div>
              </div>
            </div>
            <section class="section-lg bg-periglacial-blue">
              <div class="shell">
                <div class="range range-md-reverse range-lg-justify range-50">
                  <div class="cell-sm-9 cell-md-6 cell-lg-5">
                  ...
                  <div class="cell-md-6">
                    <ul class="list-bars list-bars-justify-offset">
                      <li class="list-bars-item">
                        <p class="list-bars-item-header">Hair Cut</p>
                        <div class="progress-bar-js progress-bar-horizontal progress-bar-primary" data-value="60" data-stroke="10" data-counter="true" data-duration="1000" data-trail="100"></div>
                      </li>
                      <li class="list-bars-item">
                        <p class="list-bars-item-header">Hot towel shaving</p>
                        <div class="progress-bar-js progress-bar-horizontal progress-bar-primary" data-value="50" data-stroke="10" data-counter="true" data-duration="1000" data-trail="100"></div>
                      </li>
                      <li class="list-bars-item">
                        <p class="list-bars-item-header">clipper cut</p>
                        <div class="progress-bar-js progress-bar-horizontal progress-bar-primary" data-value="60" data-stroke="10" data-counter="true" data-duration="1000" data-trail="100"></div>
                      </li>
                    </ul>
                  </div>
                ...
                <div class="range range-condensed range-custom-bordered">
                  <div class="cell-xs-6 cell-sm-3">
                    <div class="counter-box">
                      <div class="counter" data-from="0" data-to="13">13</div>
                      <div class="counter-box-header">YEARS OF EXPERIENCE</div>
                    </div>
                  </div>
                  <div class="cell-xs-6 cell-sm-3">
                    <div class="counter-box">
                      <div class="counter" data-from="0" data-to="7">7</div>
                      <div class="counter-box-header">international partners</div>
                    </div>
                  </div>
                  <div class="cell-xs-6 cell-sm-3">
                    <div class="counter-box">
                      <div class="counter" data-from="0" data-to="26">26</div>
                      <div class="counter-box-header">QUALIFIED SPECIALISTS</div>
                    </div>
                  </div>
                  <div class="cell-xs-6 cell-sm-3">
                    <div class="counter-box">
                      <div class="counter" data-from="0" data-to="12">12</div>
                      <div class="counter-box-header">additional services</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section class="section-lg bg-periglacial-blue">
              <div class="shell">
                <div class="range range-50">
                  <div class="cell-xs-6 cell-sm-3">
                    <div class="progress-bar-radial-default">
                      <div class="progress-bar-radial-default-wrap">
                        <div class="progress-bar-js progress-bar-radial progress-bar-primary-v2" data-value="73" data-stroke="5" data-trail="3" data-gradient="#000000"></div>
                      </div>
                      <p class="progress-bar-radial-default-header">Leadership</p>
                    </div>
                  </div>
                  <div class="cell-xs-6 cell-sm-3">
                    <div class="progress-bar-radial-default">
                      <div class="progress-bar-radial-default-wrap">
                        <div class="progress-bar-js progress-bar-radial progress-bar-primary-v2" data-value="11" data-stroke="5" data-trail="3" data-gradient="#000000"></div>
                      </div>
                      <p class="progress-bar-radial-default-header">Management</p>
                    </div>
                  </div>
                  <div class="cell-xs-6 cell-sm-3">
                    <div class="progress-bar-radial-default">
                      <div class="progress-bar-radial-default-wrap">
                        <div class="progress-bar-js progress-bar-radial progress-bar-primary-v2" data-value="13" data-stroke="5" data-trail="3" data-gradient="#000000"></div>
                      </div>
                      <p class="progress-bar-radial-default-header">Innovation and creativity</p>
                    </div>
                  </div>
                  <div class="cell-xs-6 cell-sm-3">
                    <div class="progress-bar-radial-default">
                      <div class="progress-bar-radial-default-wrap">
                        <div class="progress-bar-js progress-bar-radial progress-bar-primary-v2" data-value="59" data-stroke="5" data-trail="3" data-gradient="#000000"></div>
                      </div>
                      <p class="progress-bar-radial-default-header">Resilience</p>
                    </div>
                  </div>
                </div>
              </div>
