        ...
        <div class="content-wrapper">
          ...
          <div id="wrapper">
            <section class="section-xs bg-periglacial-blue one-screen-page-content text-center">
              <div class="shell"><a class="link link-primary link-return" href="step-2.php">Back</a></div>
              <div class="shell">
                <h2>Choose a Date</h2>
                ...
                <div class="rd-material-tabs date-picker" data-items="2" data-xs-items="3" data-sm-items="4" data-md-items="5" data-margin="15" data-stage-padding="0" data-sm-stage-padding="30">
                  <div class="rd-material-tabs__list">
                    <ul>
                      <li><a class="date-picker-date disabled" href="#">
                          <div class="date-picker-date-number">9</div>
                          <div class="date-picker-date-text">Friday</div></a></li>
                      <li><a class="date-picker-date disabled" href="#">
                          <div class="date-picker-date-number">10</div>
                          <div class="date-picker-date-text">saturday</div></a></li>
                      <li><a class="date-picker-date" href="#">
                          <div class="date-picker-date-number">11</div>
                          <div class="date-picker-date-text">Sunday</div></a></li>
                      <li><a class="date-picker-date" href="#">
                          <div class="date-picker-date-number">12</div>
                          <div class="date-picker-date-text">monday</div></a></li>
                      <li><a class="date-picker-date" href="#">
                          <div class="date-picker-date-number">13</div>
                          <div class="date-picker-date-text">tuesday</div></a></li>
                      <li><a class="date-picker-date" href="#">
                          <div class="date-picker-date-number">14</div>
                          <div class="date-picker-date-text"> Wednesday</div></a></li>
                      <li><a class="date-picker-date" href="#">
                          <div class="date-picker-date-number">15</div>
                          <div class="date-picker-date-text"> Thursday</div></a></li>
                    </ul>
                  </div>
                  <div class="rd-material-tabs__container">
                    <div>
                      <ul class="date-picker-list animated fadeIn">
                        <li class="disabled"><a href="step-4.php">10:00 - 11:00</a></li>
                        <li class="disabled"><a href="step-4.php">11:00 - 12:00</a></li>
                        <li class="disabled"><a href="step-4.php">12:00 - 13:00</a></li>
                        <li class="disabled"><a href="step-4.php">13:00 - 14:00</a></li>
                        <li class="disabled"><a href="step-4.php">14:00 - 15:00</a></li>
                        <li class="disabled"><a href="step-4.php">15:00 - 16:00</a></li>
                        <li class="disabled"><a href="step-4.php">16:00 - 17:00</a></li>
                        <li class="disabled"><a href="step-4.php">17:00 - 18:00</a></li>
                      </ul>
                    </div>
                    <div>
                      <ul class="date-picker-list animated fadeIn">
                    ...
                    <div>
                      <ul class="date-picker-list animated fadeIn">
                        <li><a href="step-4.php">10:00 - 11:00</a></li>
                        <li class="disabled"><a href="step-4.php">11:00 - 12:00</a></li>
                        <li><a href="step-4.php">12:00 - 13:00</a></li>
                        <li class="disabled"><a href="step-4.php">13:00 - 14:00</a></li>
                        <li class="disabled"><a href="step-4.php">14:00 - 15:00</a></li>
                        <li><a href="step-4.php">15:00 - 16:00</a></li>
                        <li><a href="step-4.php">16:00 - 17:00</a></li>
                        <li class="disabled"><a href="step-4.php">17:00 - 18:00</a></li>
                      </ul>
                    </div>
                    <div>
