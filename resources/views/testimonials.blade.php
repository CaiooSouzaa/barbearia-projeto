          ...
          <div id="wrapper">
            <div class="page-title">
              <div class="page-title-content">
                <div class="shell">
                  <p class="page-title-header">Testimonials</p>
                  <div class="unit unit-spacimg-md unit-xs-horizontal unit-align-center unit-middle">
                    <div class="unit-left text-sm-right">
                      ...
                      <p>4.66 average from 169 reviews</p>
                    </div>
                    <div class="unit-body"><a class="btn btn-sm btn-circle btn-primary" href="#">Write a review</a></div>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="cell-lg-10">
                    <blockquote class="quote-fullwidth">
                      <div class="quote-fullwidth-left">
                        <div class="quote-fullwidth-avatar"><img src="img/testimonials-1-100x100.jpg" alt="" width="100" height="100"/>
                        </div>
                      </div>
                      <div class="quote-fullwidth-body">
                        <div class="quote-fullwidth-header">
                          <cite>Matt Parker</cite>
                          <ul class="quote-fullwidth-rating">
                            <li class="icon icon-primary fa fa-star"></li>
                            <li class="icon icon-primary fa fa-star"></li>
                            <li class="icon icon-primary fa fa-star"></li>
                            <li class="icon icon-primary fa fa-star"></li>
                            <li class="icon icon-primary fa fa-star"></li>
                    ...
                    <blockquote class="quote-fullwidth">
                      <div class="quote-fullwidth-left">
                        <div class="quote-fullwidth-avatar"><img src="img/testimonials-2-100x100.jpg" alt="" width="100" height="100"/>
                        </div>
                      </div>
                      <div class="quote-fullwidth-body">
                        <div class="quote-fullwidth-header">
                    ...
                    <blockquote class="quote-fullwidth">
                      <div class="quote-fullwidth-left">
                        <div class="quote-fullwidth-avatar"><img src="img/testimonials-3-100x100.jpg" alt="" width="100" height="100"/>
                        </div>
                      </div>
                      <div class="quote-fullwidth-body">
                        <div class="quote-fullwidth-header">
                ...
                <div class="range range-sm-center range-75">
                  ...
                  <div class="cell-xs-12">
                    <div class="row isotope" data-isotope-layout="moduloColumns">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-4 isotope-item">
                        <blockquote class="quote-card">
                          <div class="quote-card-avatar"><img class="quote-card-image" src="img/testimonials-4-100x100.jpg" alt="" width="100" height="100"/>
                          </div>
                          <div class="quote-card-header">
                            <cite>Jim McMillan</cite>
                          </div>
                          <ul class="quote-card-rating">
                            <li class="icon icon-xs icon-primary fa fa-star"></li>
                            <li class="icon icon-xs icon-primary fa fa-star"></li>
                          ...
                          <p class="quote-card-text">
                            <q>Down to earth friendly professional service with no pretentious nonsense which you would expect from a barber in this area. Barbers are well trained and experienced and always give a first class haircut according to your requirements and are always happy to give advice for a style that suits you.</q>
                          </p>
                          <ul class="inline-list inline-list-md">
                            <li><a class="icon icon-xs link-gray-base fa-facebook" href="#"></a></li>
                            <li><a class="icon icon-xs link-gray-base fa-twitter" href="#"></a></li>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-4 isotope-item">
                        <blockquote class="quote-card">
                          <div class="quote-card-avatar"><img class="quote-card-image" src="img/testimonials-5-100x100.jpg" alt="" width="100" height="100"/>
                          </div>
                          <div class="quote-card-header">
                            <cite>David Flores</cite>
                          </div>
                          <ul class="quote-card-rating">
                            <li class="icon icon-xs icon-primary fa fa-star"></li>
                            <li class="icon icon-xs icon-primary fa fa-star"></li>
                          ...
                          <p class="quote-card-text">
                            <q>This is without doubt the finest and best value barber shop in the city. I started going here in response to a series of really bad haircuts at shops local to where I live.</q>
                          </p>
                          <ul class="inline-list inline-list-md">
                            <li><a class="icon icon-xs link-gray-base fa-facebook" href="#"></a></li>
                            <li><a class="icon icon-xs link-gray-base fa-twitter" href="#"></a></li>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-4 isotope-item">
                        <blockquote class="quote-card">
                          <div class="quote-card-avatar"><span>P</span>
                          </div>
                          <div class="quote-card-header">
                            <cite>Patrick Perez</cite>
                          </div>
                          <ul class="quote-card-rating">
                            <li class="icon icon-xs icon-primary fa fa-star"></li>
                            <li class="icon icon-xs icon-primary fa fa-star"></li>
                          ...
                          <p class="quote-card-text">
                            <q>I’ve recently had my haircut with Harry, and it’s by far the best haircut I’ve ever had! It feels good knowing that I’ve found a barber who can make me look and feel my best.</q>
                          </p>
                          <ul class="inline-list inline-list-md">
                            <li><a class="icon icon-xs link-gray-base fa-facebook" href="#"></a></li>
                            <li><a class="icon icon-xs link-gray-base fa-twitter" href="#"></a></li>
                  ...
                  <div class="cell-lg-10">
                    <blockquote class="quote-review">
                      <div class="quote-review-left">
                        <div class="quote-review-avatar"><img class="quote-review-image" src="img/testimonials-1-100x100.jpg" alt="" width="100" height="100"/>
                        </div>
                      </div>
                    ...
                    <blockquote class="quote-review">
                      <div class="quote-review-left">
                        <div class="quote-review-avatar"><img class="quote-review-image" src="img/testimonials-3-100x100.jpg" alt="" width="100" height="100"/>
                        </div>
                      </div>
                      <div class="quote-review-body">
                        <div class="quote-review-header">
