            ...
            <div class="shop-panel">
              <div class="shell">
                <div class="shop-panel-inner">
                  <div class="shop-panel-left"><a class="shop-panel-link" href="cart.php"><span class="icon fa fa-shopping-cart"></span><span class="count">2</span></a><span class="shop-panel-price">$35.99</span></div>
                  <div class="shop-panel-right">
                    <div class="shop-panel-select"><span class="shop-panel-select-title">Category</span>
                      <select class="form-control select-filter" data-minimum-results-for-search="Infinity" data-custom-theme="modern">
                        ...
                        <option value="6">Category 3</option>
                      </select>
                    </div>
            ...
            <section class="section-md bg-periglacial-blue text-center">
              <div class="shell">
                <div class="range range-30">
                  ...
                  <div class="cell-sm-6 cell-md-4">
                    <article class="product"><a class="product-image" href="single-product.php"><img src="img/product-2-210x168.png" alt="" width="210" height="168"/></a>
                      <p class="product-title"><a href="single-product.php">dovo en Vogue 5/8</a></p>
                  ...
                  <div class="cell-sm-6 cell-md-4">
                    <article class="product"><a class="product-image" href="single-product.php"><img src="img/product-3-175x168.png" alt="" width="175" height="168"/></a>
                      <p class="product-title"><a href="single-product.php">Ducky Matte premium Pomade</a></p>
                  ...
                  <div class="cell-sm-6 cell-md-4">
                    <article class="product"><a class="product-image" href="single-product.php"><img src="img/product-1-164x168.png" alt="" width="164" height="168"/></a>
                      <p class="product-title"><a href="single-product.php">uppercut deluxe extra</a></p>
                  ...
                  <div class="cell-sm-6 cell-md-4">
                    <article class="product"><a class="product-image" href="single-product.php"><img src="img/product-1-164x168.png" alt="" width="164" height="168"/></a>
                      <p class="product-title"><a href="single-product.php">Uppercut premium pomade</a></p>
                  ...
                  <div class="cell-sm-6 cell-md-4">
                    <article class="product"><a class="product-image" href="single-product.php"><img src="img/product-2-210x168.png" alt="" width="210" height="168"/></a>
                      <p class="product-title"><a href="single-product.php">Timor 5/8</a></p>
                  ...
                  <div class="cell-sm-6 cell-md-4">
                    <article class="product"><a class="product-image" href="single-product.php"><img src="img/product-3-175x168.png" alt="" width="175" height="168"/></a>
                      <p class="product-title"><a href="single-product.php">Ducky Matte deluxe Pomade</a></p>
