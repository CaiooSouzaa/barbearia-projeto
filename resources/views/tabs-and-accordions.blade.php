          ...
          <div id="wrapper">
            <div class="page-title">
              <div class="page-title-content">
                <div class="shell">
                  <p class="page-title-header">Tabs &amp; Accordions</p>
                </div>
              </div>
            </div>
                  ...
                  <div class="cell-lg-10">
                    ...
                    <div class="tabs-custom tabs-horizontal tabs-corporate" id="tabs-1">
                      <ul class="nav nav-tabs">
                        <li class="active"><a href="#tabs-1-1" data-toggle="tab">Tab 1</a></li>
                        <li><a href="#tabs-1-2" data-toggle="tab">Tab 2</a></li>
                        <li><a href="#tabs-1-3" data-toggle="tab">Tab 3</a></li>
                        <li><a href="#tabs-1-4" data-toggle="tab">Tab 4</a></li>
                      </ul>
                  ...
                  <div class="cell-lg-10">
                    ...
                    <div class="tabs-custom tabs-vertical tabs-corporate" id="tabs-2">
                      <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tabs-2-5" data-toggle="tab">Tab 4</a></li>
                      </ul>
                      <div class="tab-content">
                    ...
                    <div class="panel-group panel-group-custom panel-group-light" id="accordionOne" role="tablist" aria-multiselectable="true">
                      <div class="panel panel-custom panel-light">
                        <div class="panel-heading" id="accordionOneHeading1" role="tab">
                          <div class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordionOne" href="#accordionOneCollapse1" aria-controls="accordionOneCollapse1" aria-expanded="true">How can I change something in my order?
                        ...
                        <div class="panel-collapse collapse in" id="accordionOneCollapse1" role="tabpanel" aria-labelledby="accordionOneHeading1">
                          <div class="panel-body">
                            <p>If you need to change something in your order, please contact us immediately. We usually process orders within 2-4 hours, and once we have processed your order, we will be unable to make any changes. </p>
                          </div>
                        </div>
                      </div>
                      <div class="panel panel-custom panel-light">
                        <div class="panel-heading" id="accordionOneHeading2" role="tab">
                          <div class="panel-title"><a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionOne" href="#accordionOneCollapse2" aria-controls="accordionOneCollapse2">How can I pay for my order?
                              <div class="panel-arrow"></div></a>
                          </div>
                        </div>
                      ...
                      <div class="panel panel-custom panel-light">
                        <div class="panel-heading" id="accordionOneHeading3" role="tab">
                          <div class="panel-title"><a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionOne" href="#accordionOneCollapse3" aria-controls="accordionOneCollapse3">How long will my order take to be delivered?
                              <div class="panel-arrow"></div></a>
                          </div>
                        </div>
                        <div class="panel-collapse collapse" id="accordionOneCollapse3" role="tabpanel" aria-labelledby="accordionOneHeading3">
                          <div class="panel-body">
                            <p>Delivery times will depend on your location. Once payment is confirmed your order will be packaged. Delivery can be expected within 10 business days. </p>
                          </div>
                        </div>
                      </div>
                      <div class="panel panel-custom panel-light">
                        <div class="panel-heading" id="accordionOneHeading4" role="tab">
                          <div class="panel-title"><a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionOne" href="#accordionOneCollapse4" aria-controls="accordionOneCollapse4">Can I return an item?
                              <div class="panel-arrow"></div></a>
                          </div>
                        </div>
                        <div class="panel-collapse collapse" id="accordionOneCollapse4" role="tabpanel" aria-labelledby="accordionOneHeading4">
                          <div class="panel-body">
                            <p>Please visit our Returns &amp; Exchanges page for more information. </p>
                          </div>
                        </div>
                      </div>
                      <div class="panel panel-custom panel-light">
                        <div class="panel-heading" id="accordionOneHeading5" role="tab">
                          <div class="panel-title"><a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionOne" href="#accordionOneCollapse5" aria-controls="accordionOneCollapse5">Can I track my order?
                              <div class="panel-arrow"></div></a>
                          </div>
                        </div>
