        ...
        <div class="content-wrapper">
          ...
          <div id="wrapper">
            <section class="section-xl bg-periglacial-blue">
              <div class="shell"><a class="link link-primary link-return" href="shop.php">Back</a>
                <article class="product-single">
                  <div class="product-single-left">
                    <div class="slick-carousel-product">
                      ...
                      <div class="slick-slider carousel-parent" data-arrows="false" data-dots="false" data-loop="true" data-swipe="true" data-items="1" data-child="#child-carousel" data-for="#child-carousel">
                        <div class="item"><img src="img/product-single-1-274x280.png" alt="" width="274" height="280"/>
                        </div>
                        <div class="item"><img src="img/product-single-2-274x280.png" alt="" width="274" height="280"/>
                        </div>
                        <div class="item"><img src="img/product-single-3-274x280.png" alt="" width="274" height="280"/>
                        </div>
                        <div class="item"><img src="img/product-single-4-274x280.png" alt="" width="274" height="280"/>
                        </div>
                      </div>
                  ...
                  <div class="product-single-body">
                    <p class="product-single-title">Uppercut Deluxe</p>
                    <div class="product-single-price-wrap">
                      <p class="price">$34.99</p><small>(In Stock)</small>
                    </div>
                    <div class="product-single-text">
                      <p>With strong hold and just the right amount of shine that doesn’t dry out, this Pomade provided by Uppercut has it all. The best bit – it washes out easily and is safe for your hair. Deluxe Pomade has been designed for discerning men who have a particular style in mind. It is perfect for timeless, classic looks.</p>
                    </div><a class="btn-shop btn-shop-sm" href="cart.php"><span class="btn-shop-icon fa fa-shopping-cart"></span><span class="btn-shop-text">ADD TO CART</span></a>
                  </div>
                </article>
              </div>
            </section>
                  ...
                  <div class="cell-xs-12">
                    <div class="range range-30">
                      <div class="cell-sm-6 cell-md-4 height-fill">
                        <article class="product"><a class="product-image" href="single-product.php"><img src="img/product-1-164x168.png" alt="" width="164" height="168"/></a>
                          <p class="product-title"><a href="single-product.php">Uppercut deluxe</a></p>
                          <p class="product-price">$34.99
                          </p><a class="btn-shop" href="cart.php"><span class="btn-shop-icon fa fa-shopping-cart"></span><span class="btn-shop-text">ADD TO CART</span></a>
                        </article>
                      </div>
                      <div class="cell-sm-6 cell-md-4 height-fill">
                        <article class="product"><a class="product-image" href="single-product.php"><img src="img/product-2-210x168.png" alt="" width="210" height="168"/></a>
                          <p class="product-title"><a href="single-product.php">Thiers Issard SING-6/8-188-OL</a></p>
                          <p class="product-price">$25.99
                          </p><a class="btn-shop" href="cart.php"><span class="btn-shop-icon fa fa-shopping-cart"></span><span class="btn-shop-text">ADD TO CART</span></a>
                        </article>
                      </div>
                      <div class="cell-sm-6 cell-md-4 height-fill">
                        <article class="product"><a class="product-image" href="single-product.php"><img src="img/product-3-175x168.png" alt="" width="175" height="168"/></a>
                          <p class="product-title"><a href="single-product.php">Ducky Matte Pomade</a></p>
