      ...
      <main class="page-content" id="perspective">
        <div class="content-wrapper">
          <div class="page-header page-header-perspective">
            ...
            <div class="page-header-center">
              <div class="step-progress">
                <p class="step-progress-caption">Almost done</p>
              </div>
            </div>
          ...
          <div class="custom-progress">
            <div class="custom-progress-body" style="width: 100%;"></div>
          </div>
          <div id="wrapper">
            <section class="section-xs bg-periglacial-blue one-screen-page-content text-center">
              <div class="shell"><a class="link link-primary link-return" href="step-3.php">Back</a></div>
              <div class="shell">
                <h2>ONE MORE STEP!</h2>
                <div class="p text-width-medium">
                  <p class="big">To complete your appointment, please review all details described below. Don’t forget to provide your name and phone and telephone so that we could contact you.</p>
                </div>
                  ...
                  <div class="box-contacts-col box-contacts-right">
                    <div class="box-contacts-block">
                      <form action="finish.php">
                        ...
                        <button class="btn btn-sm btn-primary btn-block btn-circle" type="submit">Book now</button>
                      </form>
                    </div>
                  </div>
                </div>
